...
<div class="table container mt-2" style="display:none">
  ...
  <tbody>
    ...
    $sql="select q.Qid,Question,(select up.options FROM usersans a join usersoption up on up.id=a.optid  where a.Uid='$user_id' and a.Qid=q.Qid Limit 1)ans,(Select ans from friendsans fa where fa.q_no=q.Qid and fa.friendid=$urid Limit 1)friendanswer from usersq q where q.Uid='$user_id' ";
